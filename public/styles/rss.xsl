      ...
      <body class="bg-gray-100 text-gray-900 p-6">
        <div class="max-w-3xl mx-auto">
          ...
          <div class="mt-6 flex justify-center">
            <a href="/"
              class="px-4 py-2 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600 transition">Kembali
              ke Halaman Utama</a>
          </div>
        </div>
      </body>
  ...
  <xsl:template match="item">
    <li class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
      <a href="{link}" class="block">
        ...
        <p class="text-sm text-gray-600 mt-1"> Dipublikasikan pada <xsl:value-of select="pubDate" />
        </p>
